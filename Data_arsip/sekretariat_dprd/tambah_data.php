...
if (isset($_POST['tambahdata'])) {
    ...
    // buat query
    $sql = "INSERT INTO sekretariatdprd (kode_klasifikasi, no_box, no_berkas, uraian, tahun, jumlah, ket, file) VALUES ('$kode_klasifikasi', '$no_box', '$no_berkas', '$uraian', '$tahun', '$jumlah', '$ket', '$file_name')";
