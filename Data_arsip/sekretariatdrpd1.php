                    ...
                    <div class="card-header">
                            ...
                            <div class="container-fluid modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="#" method="POST">
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="inputEmail3" name="kd_klasifikasi">
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label for="inputPassword3" class="col-sm-4 col-form-label">No BOX</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="inputPassword3" name="no_box">
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="inputPassword3" name="ket">
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button name="daftar" type="submit" value="Daftar" class="btn btn-primary">Save</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <?php
                          ...
                          if(isset($_POST['daftar'])){
                              ...
                              // buat query
                              $sql = "INSERT INTO sekretariatdprd (kd_klasifikasi, no_box, no_berkas, uraian, tahun, jumlah, ket) VALUE ('$kode_kalsifikasi', '$no_box', '$no_berkas', '$uraian', '$tahun', '$jumlah', '$ket')";
                              $query = mysqli_query($db, $sql);

                              // apakah query simpan berhasil?
                              if( $query ) {
                                  // kalau berhasil alihkan ke halaman index.php dengan status=sukses
                                  header('Location: sekretariatdrpd.php?status=sukses');
                              } else {
                                  // kalau gagal alihkan ke halaman indek.php dengan status=gagal
                                  header('Location: sekretariatdrpd.php?status=gagal');
                              }
                          } else {
                              die("Akses dilarang...");
                          }
